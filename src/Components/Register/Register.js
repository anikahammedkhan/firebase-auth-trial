    ...
    return (
        <div class="bg-grey-lighter min-h-screen flex flex-col">
            <div class="px-6 py-12 flex justify-center">
                <div class="md:w-8/12 lg:w-5/12 lg:ml-20  bg-stone-100 rounded-xl py-16 px-12">
                    <h1 class="mb-8 text-3xl text-center text-blue-600 font-bold">Sign up</h1>
                    <input
                        type="text"
                    ...
                    <div class="text-center text-sm text-gray-800 mt-4">
                        ...
                        <a class="text-blue-600 pl-2" href="/">
                            Terms of Service
                        </a> and
                        <a class="text-blue-600 pl-2" href="/">
                            Privacy Policy
                    ...
                    <div class="mt-6 text-green-500 text-right">
                        Already have an account?
                        <Link class="text-blue text-blue-500 pl-2" to="/login">
                            Log in
                        </Link>.
                    </div>
                </div>
